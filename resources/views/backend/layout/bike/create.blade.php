...
@section('content')
    ...
    <div class="row">
        ...
        <h4 class="text-center mb-5">Fillup the form with appropiate informations</h1>
...
@csrf
                ...
                <div class="col-10">
                    <input class="form-control @error('brand') is-invalid @enderror" type="text" name="brand" placeholder="Enter the bike brand name" id="example-number-input" value="{{ old('brand')}}">
                ...
                <div class="col-10">
                    <input class="form-control  @error('model') is-invalid @enderror" type="text" name="model" placeholder="Enter the bike model name" id="example-number-input" value="{{ old('model')}}">
                ...
                <div class="col-10">
                    <input class="form-control  @error('year') is-invalid @enderror" type="number" name="year" placeholder="Enter the bike model year" id="example-number-input" value="{{ old('year')}}">
                ...
                <div class="col-10">
                    <input class="form-control @error('cc') is-invalid @enderror" type="text" name="cc" placeholder="Enter the bike CC" id="example-number-input" value="{{ old('cc')}}">
                ...
                <div class="col-10">
                    <input class="form-control @error('type')  is-invalid @enderror" type="text" name="type" placeholder="Enter the bike type" id="example-number-input" value="{{ old('type')}}">
                ...
                <div class="col-10">
                    <input class="form-control @error('engine_no') is-invalid @enderror" type="text" name="engine_no" placeholder="Enter the bike engine number" id="example-number-input" value="{{ old('engine_no')}}">
                ...
                <div class="col-10">
                    <input class="form-control" type="date" placeholder="Enter the date of today" name="date" id="example-date-input" value="{{ old('date')}}">
                ...
                <div class="col-10">
                    <input class="form-control @error('total_service') is-invalid @enderror" type="text" name="total_service" placeholder="Enter the bike free service number" id="example-number-input" value="{{ old('total_service')}}">
